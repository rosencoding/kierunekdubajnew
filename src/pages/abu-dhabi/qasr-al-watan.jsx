...
import { FaClock, FaMapMarkerAlt, FaStar, FaCalendarAlt, FaInfoCircle, FaTicketAlt, FaCamera, FaUniversity, FaLandmark } from 'react-icons/fa';

const QasrAlWatanPage = () => {
  const [selectedImage, setSelectedImage] = useState(null);

  const funFacts = [
    "Otwarty dla publiczności w 2019 roku",
    "Zbudowany z białego wapienia i granitu",
    "Posiada jedną z największych kopuł na świecie",
    "Biblioteka zawiera ponad 50,000 rzadkich książek i manuskryptów",
    "Fasada pałacu mierzy 1 kilometr długości",
    "Wieczorem odbywa się spektakularny pokaz świetlny",
    "Znajduje się tu Sala Ducha Współpracy",
    "Jest oficjalną siedzibą rządu ZEA"
  ];
  ...
  const attractions = [
    {
      title: "Wielka Sala",
      description: "Imponująca sala z ogromną kopułą i kryształowymi żyrandolami, miejsce oficjalnych spotkań państwowych."
    },
    {
      title: "Biblioteka",
      description: "Bogata kolekcja rzadkich książek, manuskryptów i map dokumentujących historię świata arabskiego."
    },
    {
      title: "Sala Ducha Współpracy",
      description: "Interaktywna wystawa prezentująca współpracę między narodami arabskimi."
    },
    {
      title: "Ogrody Pałacowe",
      description: "Pięknie zaprojektowane ogrody z fontannami i tradycyjnymi arabskimi wzorami."
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ 
            backgroundImage: 'url("/images/qasr-al-watan.jpg")',
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center">
          <div className="max-w-4xl px-4">
            ...
            <p className="text-xl text-white/90 mb-8">
              Pałac Prezydencki Abu Dhabi
            </p>
            <a
              href="https://gyg.me/YMxtk6zn"
              target="_blank"
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-12">
          ...
          <p className="text-gray-600 mb-6">
            Qasr Al Watan, znany również jako Pałac Narodów, to architektoniczne arcydzieło 
            i kulturalna duma Abu Dhabi. Ten majestatyczny biały pałac jest nie tylko siedzibą 
            rządu Zjednoczonych Emiratów Arabskich, ale także żywym muzeum prezentującym arabskie 
            dziedzictwo, sztukę i design. Zwiedzający mogą podziwiać imponujące sale, w tym 
            Wielką Salę z jedną z największych kopuł na świecie, bibliotekę z rzadkimi 
            manuskryptami oraz liczne wystawy prezentujące historię i kulturę regionu. 
            Wieczorem pałac zamienia się w scenę dla zapierającego dech w piersiach pokazu 
            świetlnego, który opowiada historię ZEA.
          </p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-8 mb-12">
          ...
          <div 
            ...
            data-gyg-cmp="qasr-al-watan" 
            data-gyg-partner-id="PDKWF6M" 
            data-gyg-q="qasr al watan abu dhabi"
          >
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                <FaUniversity className="text-xl text-blue-500 mt-1" />
                <div>
                  <h3 className="font-semibold">Przewodnicy i Audio Guide</h3>
                  <p className="text-gray-600">Dostępni przewodnicy mówiący w wielu językach oraz audio przewodniki.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Nowoczesne, interaktywne ekspozycje edukacyjne.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Wczesne godziny poranne lub późne popołudnie na pokaz świetlny.</p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Wymagany odpowiedni strój - zakryte ramiona i kolana.</p>
                </div>
              </div>
            </div>
          </div>
