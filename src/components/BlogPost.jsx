...
const BlogPost = ({ post }) => {
  ...
  return (
    <>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12" itemScope itemType="http://schema.org/Article">
        <Link
          to="/blog"
        ...
        <header className="mb-8">
          <h1 className="text-4xl font-bold mb-4 text-gray-900" itemProp="headline">
            {post.title}
          </h1>
